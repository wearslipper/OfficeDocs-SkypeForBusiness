...
- If you select **Type a greeting message**, the system will read the text that you type (up to 1,000 characters) when the auto attendant answers a call. Special characters such as "@" and "&" aren't supported, and their use could result in the greeting not playing. Use the full word such as "at" and "and" in the greeting text.
